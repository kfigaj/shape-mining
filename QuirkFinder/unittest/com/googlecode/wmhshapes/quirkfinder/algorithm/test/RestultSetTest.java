...
import com.googlecode.wmhshapes.quirkfinder.algorithm.bruteforce.ResultSet;
...
public class RestultSetTest {
	...
	public void setUp() throws Exception {
		...
		for (int i = 0; i < ImprovedBruteForce.SAX_RESULTS; ++i) {
	...
	public void testFullSet() {
		...
		assertEquals(ImprovedBruteForce.SAX_RESULTS, fullResultSet.getSAXSet()
				.size());
	}
